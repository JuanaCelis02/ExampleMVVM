...
class QuoteProvider {
    ...
    //Como estamos en una clase no podemos acceder a ella desde aca
    //Es necesario crear un companion object
    //Viene siendo como una clase estatica
    //Pueden acceder a la clase si estan dentro del companion object
    ...
    companion object{
        ...
        private val quote = listOf<QuoteModel>(
            ...
            QuoteModel(quote = "Things aren’t always #000000 and #FFFFFF",
                author = "Anonymous"),
            QuoteModel(quote = "Talk is cheap. Show me the code.",
